...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
	  <h1 class="page-header" style="text-align:right">GDP Detail</h1><br/>

    <h2>Indicator : <?php echo $gdp[0]['indicator'];?></h2>
    <h3>Country : <?php echo $gdp[0]['country'];?></h3>
    <br/>
